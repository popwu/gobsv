...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_get_public_key(extended_public_key: *mut BSVExtendedPublicKey) -> *mut BSVPublicKey {
...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_from_xpriv(xpriv: *mut BSVExtendedPrivateKey) -> *mut BSVExtendedPublicKey {
...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_get_chain_code(extended_public_key: *mut BSVExtendedPublicKey) -> *mut ByteArray {
    let extended_public_key = unsafe { &mut *extended_public_key };
    let chain_code = extended_public_key.get_chain_code();
...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_get_depth(extended_public_key: *mut BSVExtendedPublicKey) -> u8 {
    let extended_public_key = unsafe { &mut *extended_public_key };
...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_get_parent_fingerprint(extended_public_key: *mut BSVExtendedPublicKey) -> *mut ByteArray {
    let extended_public_key = unsafe { &mut *extended_public_key };
    let parent_fingerprint = extended_public_key.get_parent_fingerprint();
...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_get_index(extended_public_key: *mut BSVExtendedPublicKey) -> u32 {
    let extended_public_key = unsafe { &mut *extended_public_key };
...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_derive(extended_public_key: *mut BSVExtendedPublicKey, index: u32) -> *mut BSVExtendedPublicKey {
    let extended_public_key = unsafe { &mut *extended_public_key };
...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_derive_from_path(extended_public_key: *mut BSVExtendedPublicKey, path: *mut libc::c_char) -> *mut BSVExtendedPublicKey {
    let extended_public_key = unsafe { &mut *extended_public_key };
...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_from_seed(seed: *mut u8, len: usize) -> *mut BSVExtendedPublicKey {
...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_from_string(xpub_string: *mut libc::c_char) -> *mut BSVExtendedPublicKey {
...
// }
#[no_mangle]
pub extern "C" fn extended_public_key_to_string(extended_public_key: *mut BSVExtendedPublicKey) -> *mut libc::c_char {
    let extended_public_key = unsafe { &mut *extended_public_key };
